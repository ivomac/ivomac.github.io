...
const SITE_STRUCTURE = {
    ...
    'projects/qrt_challenge': { name: '📈 QRT Challenge', path: '/pages/projects/qrt_challenge/index.html' },
    'projects/nxtint': { name: '🔢 Next Integer Prediction', path: '/pages/projects/nxtint/index.html' },
    'projects/fzf_nav': { name: '🔍 zsh-fzf-nav', path: '/pages/projects/fzf_nav/index.html' },
    'projects/cl_gen': { name: '✉️ Cover Letter Generator', path: '/pages/projects/cl_gen/index.html' },
    'projects/nxtint': { name: '🧮 Next Integer Prediction', path: '/pages/projects/nxtint/index.html' },
    'projects/qrt_challenge': { name: '📈 QRT Challenge', path: '/pages/projects/qrt_challenge/index.html' },
    'projects/fzf_nav': { name: '🔍 fzf-nav', path: '/pages/projects/fzf_nav/index.html' },
